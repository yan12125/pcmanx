 ...
 : CWidget(), m_Site(site)
{
	...
	GtkWidget *hbox3;
	GtkWidget *label3;
	GTK_ADJUSTMENT_TYPE *m_Reconnect_adj;
	GtkWidget *label4;
	GtkWidget *hbox6;
	GtkWidget *label10;
	GTK_ADJUSTMENT_TYPE *m_Idle_adj;
	GtkWidget *label11;
	GtkWidget *hbox7;
	GtkWidget *label12;
	GtkWidget *hbox13;
	...
	GtkWidget *hbox14;
	GtkWidget *label22;
	GTK_ADJUSTMENT_TYPE *m_Line_adj;
	GtkWidget *label23;
	GTK_ADJUSTMENT_TYPE *m_Col_adj;
	GtkWidget *hbox10;
	GtkWidget *label20;
	GtkWidget *label21;
	GtkWidget *hbox15;
	GtkWidget *label24;
	GTK_ADJUSTMENT_TYPE *m_PasteWrap_adj;
	GtkWidget *label25;
	GtkWidget *hbox25;
	GtkWidget *label39;
	...
	m_Reconnect_adj = gtk_adjustment_new (0, 0, 65535, 1, 0, 0);
	...
	m_Idle_adj = gtk_adjustment_new (0, 0, 65535, 1, 0, 0);
	...
	m_Line_adj = gtk_adjustment_new (24, 24, 96, 1, 0, 0);
	...
	m_Col_adj = gtk_adjustment_new (80, 40, 240, 1, 0, 0);
	...
	m_PasteWrap_adj = gtk_adjustment_new (78, 0, 100, 1, 0, 0);
